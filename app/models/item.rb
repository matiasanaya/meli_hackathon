class Item < ActiveRecord::Base
  attr_accessible :has_stock, :meli_id, :user_id, :meli_stock, :meli_title, :stock_tracked, :sold_quantity
  ...
  def update_from_meli!(user)
    item_info = JSON.parse(user.get("/items/#{@id}").body)
